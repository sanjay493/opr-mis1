    ...
    if (param === 'Hot Metal Consumption' || param === 'Scrap Consumption') {
      return (
        <div style={{ padding: '12px 16px', backgroundColor: '#f0fdf4', borderTop: '1px solid #d1fae5' }}>
          <div style={{ fontSize: '12pt', fontWeight: '600', color: '#065f46', marginBottom: '8px' }}>{calcData.formula}</div>
    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f8fafc' }}>
      ...
      <main style={{ flex: 1, overflow: 'auto', padding: '32px', maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{
          ...
          <button onClick={handleLoad} disabled={loading} style={{ padding: '8px 16px', fontSize: '13pt', fontWeight: '600', borderRadius: '4px', border: 'none', backgroundColor: '#6366f1', color: '#fff', cursor: 'pointer', marginTop: '18px' }}>
        ...
        {status && (
          <div style={{
            padding: '12px 16px', marginBottom: '16px', borderRadius: '6px', fontSize: '13pt',
        ...
        {prodMetadata && (
          <div style={{
            ...
            <div style={{ marginTop: '8px', paddingTop: '8px', borderTop: '1px solid #e0e7ff' }}>
              ...
              <div style={{ fontSize: '13pt', display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '8px', marginTop: '4px' }}>
        ...
        {smsParams.length > 0 && (
          <div>
            ...
            {(smsCalcDetails['Hot Metal Consumption'] || smsCalcDetails['Scrap Consumption']) && (
              <div style={{ marginTop: '16px' }}>
                <h3 style={{ fontSize: '13pt', fontWeight: '600', color: '#065f46', margin: '0 0 12px 0' }}>📐 Calculation Details</h3>
                {smsCalcDetails['Hot Metal Consumption'] && (
                  <div style={{ marginBottom: '12px' }}>
                    <div style={{ fontSize: '12pt', fontWeight: '600', color: '#065f46', marginBottom: '8px' }}>HM Consumption SAIL</div>
                    {renderCalcDetails('Hot Metal Consumption', smsCalcDetails['Hot Metal Consumption'])}
                  </div>
                )}
                {smsCalcDetails['Scrap Consumption'] && (
                  <div>
                    <div style={{ fontSize: '12pt', fontWeight: '600', color: '#065f46', marginBottom: '8px' }}>Scrap Consumption SAIL</div>
