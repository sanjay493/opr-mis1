              ...
              <div className="form-group" style={{ marginBottom: '15px' }}>
                ...
                <div style={{ fontSize: '7.5pt', color: '#fbbf24', marginTop: '4px' }}>
                  {technoPlant === 'RSP_TECHNO'
                    ...
                    : technoPlant === 'ASP'
                    ? "asp.xlsx → reads cells F10/F11/F13/F21/L26 (Crude Steel, Concast, Ingot, Saleable, Stock). Month auto-detected from E3. REP*.pdf → Total Crude Steel, Total Caster, Ingot Steel, Saleable Steel, Closing Stock (month auto-detected from its own \"...REPORT FOR DD/MM/YYYY\" line). FL*.pdf → Ingot Steel, Billets, BARS, PLATES, Saleable Steel for both the report month and the previous month (report month auto-detected from the table's own header)."
                    : technoPlant === 'SSP'
