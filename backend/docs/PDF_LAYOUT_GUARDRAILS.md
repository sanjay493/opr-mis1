...
**Known-good layout:** git tag `pdf-layout-baseline-2026-09-23`
...
git checkout pdf-layout-baseline-2026-09-23 -- backend/page_templates/main.html

rem 3. ...or restore EVERY layout file at once
git checkout pdf-layout-baseline-2026-09-23 -- backend/pdf.py backend/layout_config.json backend/chart_utils.py backend/page_at_a_glance.py backend/page_special_steel_donut.py backend/page_coal_consumption.py backend/page_templates
