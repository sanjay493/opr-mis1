...
**Known-good layout:** git tag `pdf-layout-baseline-2026-09-23b`
(full report for Aug 2026: 97 pages, footers "Page 1 of 95" to "95 of 95",
trend section 12 pages, no layout warnings).
...
git checkout pdf-layout-baseline-2026-09-23b -- backend/page_templates/main.html

rem 3. ...or restore EVERY layout file at once
git checkout pdf-layout-baseline-2026-09-23b -- backend/pdf.py backend/layout_config.json backend/chart_utils.py backend/page_at_a_glance.py backend/page_special_steel_donut.py backend/page_coal_consumption.py backend/page_templates
...
100%. As of the baseline these pages are fitted: 2.2 (96%), 22 (98%),
24 (92%), 27–30 (95–97%), 35.7 (96%), 38 (96%), 1062 (89%); landscape 2.41,
2.42, 1025 (95–97%).
