#!/usr/bin/env python3
"""
Extract BSP OISCO and insert into BOTH tables (Gradual Migration)
...
print("\n" + "="*80)
print("BSP OISCO DATA EXTRACTION - DUAL MIGRATION")
print("="*80)
...
success = dual_extract_and_insert(
    ...
    extractor_module=sys.modules['excel_extractor_bsp_oisco'],
    auto_insert=False,
...
if success:
    ...
    print("  Select: Plant=BSP, Month=2025-05")
else:
    print("\n✗ Extraction failed")
